...
namespace CropCalenderApp.Controllers
{
    public class SeasonsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,SeasonName,SeasonDesc")] Season season)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,SeasonName,SeasonDesc")] Season season)
        {
            if (ModelState.IsValid)
            {
