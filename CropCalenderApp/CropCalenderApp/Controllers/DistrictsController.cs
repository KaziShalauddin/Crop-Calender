...
namespace CropCalenderApp.Controllers
{
    public class DistrictsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,DistBbsId,DistrictName,AreaBbsId")] District district)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,DistBbsId,DistrictName,AreaBbsId")] District district)
        {
            if (ModelState.IsValid)
            {
